...
PenMods 插件：酷我 / 酷狗 / 咪咕 / 网易云 / QQ 五源搜索、歌词、封面，mpv 播放。
...
`search / lyric / pic / cover / script(musicUrl) / ping / leaderboard / songlist / hotsearch`
+ mpv 直连 `play / pause / resume / seek / volume`。
